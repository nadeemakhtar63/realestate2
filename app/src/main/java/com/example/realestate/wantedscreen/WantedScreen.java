...
public class WantedScreen extends AppCompatActivity {
    private  TextInputEditText title,description,mothrent,dateAvalible,arealooking,dimentions,rentmax,bedrooms,bathrooms;
...
//    ArrayList<Uri> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wanted_screen);
//        list = new ArrayList<>();
        btnpreview=findViewById(R.id.btnprevwanted);
...
//        recyclerView.setAdapter(adaptor);
        ...
        deteshow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(WantedScreen.this,date,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
...
btnpreview.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        stringdim=demention.getText().toString();
        ...
        {
            demention.setError("Please Enter Dimensions");
        }
        else if(stringmonthrent.isEmpty())
        {
            mothrent.setError("Minimum Rent??");
        }
        ...
        {
            Toast.makeText(WantedScreen.this, "Select any one from property type", Toast.LENGTH_SHORT).show();
        }
        else if (sellorRent=="No Data")
        {
            Toast.makeText(WantedScreen.this, "Select For Sell Or For Rent", Toast.LENGTH_SHORT).show();
        }
       else
        {
            Intent intent=new Intent(WantedScreen.this,WantedScreenReview.class);
...
//    }
    ...
    public void antedback(View view) {
        finish();
    }
}